...
@section('panel-header')
    <div>
        <ul class="breadcrumb">
            ...
            <li><i data-feather="chevron-right"></i></li>
            <li><a href="{{ route('admin.view.access.update', ['id' => $admin->id]) }}">Edit Admin Access</a></li>
        </ul>
...
@section('panel-body')
    <form action="{{ route('admin.handle.access.update', ['id' => $admin->id]) }}" method="POST"
        ...
        const handleDelete = () => {
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        window.location =
                            "{{ route('admin.handle.access.delete', ['id' => $admin->id]) }}";
                    }
                });
        }
    </script>
