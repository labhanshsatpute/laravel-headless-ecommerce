...
@section('panel-header')
    <div>
        <ul class="breadcrumb">
            ...
            <li><i data-feather="chevron-right"></i></li>
            <li><a href="{{ route('admin.view.access.create') }}">Add Admin Access</a></li>
        </ul>
...
@section('panel-body')
    <form action="{{ route('admin.handle.access.create') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <figure class="panel-card">
            ...
            <div class="panel-card-footer">
                <button type="submit" class="btn-primary-md md:w-fit sm:w-full">Add Access</button>
            </div>
        </figure>
    </form>
@endsection
